<template>
  <div class="w-screen h-screen flex">
    ...
    <div class="w-[300px] h-full bg-gray-200 text-white">
      ...
      <div class="h-[calc(100vh-50px)] bg-gray-800">
        <div class="flex flex-col justify-between h-full">
          <div class="flex flex-col space-y-[10px] mt-8">
            <router-link
              to="/home"
            ...
            <router-link
              to="/profile"
              class="inline-flex text-white relative items-center py-[10px] px-[10px] mx-5 w-fill text-sm font-medium rounded-md border-gray-200 hover:bg-gray-300 hover:text-blue-900"
            >
              <div class="pr-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="w-full h-full bg-gray-400">
      ...
      <div class="h-[calc(100vh-50px)] bg-white">Main</div>
    </div>
  </div>
</template>
